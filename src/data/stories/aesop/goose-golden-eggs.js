// The Goose That Laid Golden Eggs - Aesop's Fable
const gooseGoldenEggs = {
  ...
  description: "A farmer learns that greed can destroy the very thing that brings good fortune.",
  content: [
    {
      type: "story",
      text: "A poor farmer lived in a small cottage with his wife. They had very little money and often worried about having enough food to eat. Behind their house was a simple pen where they kept one white goose."
    },
    {
      type: "question",
      domain: "size",
    ...
    {
      type: "story",
      text: "One morning, the farmer went to check on his goose and found something amazing. Instead of a regular white egg, there was a beautiful golden egg gleaming in the nest! The egg was heavy and shiny like real gold."
    },
    {
      type: "question",
      domain: "color",
    ...
    {
      type: "story",
      text: "The farmer took the golden egg to town and sold it for enough money to buy food for a whole month! Every day after that, the goose laid another golden egg. Soon the farmer and his wife had plenty of money."
    },
    {
      type: "question",
      domain: "when",
    ...
    {
      type: "story",
      text: "As weeks passed, the farmer grew impatient. 'Why should I wait for one egg each day?' he thought. 'If I cut open the goose, I could get all the golden eggs at once and become rich immediately!'"
    },
    {
      type: "question",
      domain: "mood",
    ...
    {
      type: "story",
      text: "Despite his wife's warnings, the greedy farmer killed the goose and cut it open. But inside the goose's body, there were no golden eggs at all! The goose looked just like any ordinary bird inside."
    },
    {
      type: "question",
      domain: "what",
    ...
    {
      type: "story",
      text: "Now the farmer had no goose and no more golden eggs. He had destroyed the source of his good fortune because he wanted everything at once. The farmer and his wife returned to being poor and hungry."
    },
    {
      type: "question",
      domain: "number",
    ...
    {
      type: "story",
      text: "The farmer realized his terrible mistake. He had been so greedy for instant wealth that he destroyed the wonderful gift he already had. If only he had been patient and grateful for one golden egg each day."
    },
    {
      type: "question",
      domain: "background",
    ...
    {
      type: "story",
      moral: "Be grateful for steady, small blessings rather than risking everything for instant wealth. Greed often destroys the very thing that brings us happiness and success."
    }
  ]
};

export default gooseGoldenEggs;