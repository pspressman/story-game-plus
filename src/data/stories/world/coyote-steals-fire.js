// Navajo Native American story for visualization-based reading comprehension
const coyoteStealsFire = {
  ...
  description: "A Navajo tale about how Coyote and the other animals worked together to steal fire from the Fire Beings and bring it to the people.",
  content: [
    {
      type: "story",
      text: "In the time when the world was young, according to the Navajo people, humans lived in darkness and cold. The Fire Beings lived on a high mountain and kept all the fire for themselves. They had built a great fire that burned day and night, but they would never share its warmth."
    },
    {
      type: "question",
      domain: "background",
    ...
    {
      type: "story",
      text: "Coyote saw how the people suffered and decided to help them. But he knew he couldn't steal the fire alone. So he called together all his animal friends: Squirrel with his bushy tail, Chipmunk with her quick feet, Frog with his big mouth, and many others."
    },
    {
      type: "question",
      domain: "what",
    ...
    {
      type: "story",
      text: "'Here is my plan,' said Coyote. 'We will make a chain from the Fire Beings' mountain all the way down to the human villages. Each animal will run part of the way, passing the fire from one to the next like a relay race.'"
    },
    {
      type: "question",
      domain: "where",
    ...
    {
      type: "story",
      text: "When night came, Coyote snuck up the mountain to where the Fire Beings were sleeping around their great fire. Moving as quietly as a shadow, he grabbed a burning branch in his mouth and ran down the mountain as fast as his legs could carry him."
    },
    {
      type: "question",
      domain: "movement",
    ...
    {
      type: "story",
      text: "The Fire Beings woke up and chased after Coyote with angry shouts! Coyote ran until he reached Squirrel, who was waiting at the first station. Coyote passed the burning branch to Squirrel, who grabbed it with his tail and leaped from tree to tree."
    },
    {
      type: "question",
      domain: "mood",
    ...
    {
      type: "story",
      text: "Squirrel's tail caught fire from carrying the burning branch, but he bravely kept running until he reached Chipmunk. The flames left black stripes on Squirrel's tail forever. Chipmunk took the fire and scampered quickly over the rocks with her nimble feet."
    },
    {
      type: "question",
      domain: "color",
    ...
    {
      type: "story",
      text: "The Fire Beings were getting closer! Chipmunk passed the fire to Frog, but as she did, one of the Fire Beings scratched her back, leaving three dark stripes. Frog swallowed the fire to protect it and hopped toward the human village as fast as he could."
    },
    {
      type: "question",
      domain: "what",
    ...
    {
      type: "story",
      text: "Frog reached the human village just as the Fire Beings caught up to him. He opened his mouth and spit the fire into the wood that the humans had prepared. The fire caught instantly, giving the people light and warmth for the first time!"
    },
    {
      type: "question",
      domain: "perspective",
      question: "In your mental picture, from where would you see Frog spitting fire into the village wood?",
      options: [
        "From high above looking down at the village",
        "From behind Frog as he faced the prepared wood",
        "From deep underground looking up",
        "From inside the fire looking out"
      ],
      correctAnswer: 1,
      explanation: "To best visualize this important moment, you would picture yourself behind Frog as he faces the wood pile and gives the people their first fire."
    },
    {
      type: "story",
      text: "The Navajo people say that's why today chipmunks have stripes on their backs, squirrels have striped tails, and frogs have no tails at all—they were burned away by the fire. The animals' brave sacrifice brought the gift of fire to all people forever."
    },
    {
      type: "question",
      domain: "shape",
    ...
    {
      type: "story",
      moral: "This Navajo story teaches us that when we work together and each do our part, we can accomplish great things. Sometimes helping others requires sacrifice, but the good we do lasts forever."
    }
  ]
};

export default coyoteStealsFire;