...
const johnBaptistMinistry = {
  ...
  description: "John prepares the way for Jesus, who begins his mission with baptism and a journey through the wilderness.",
  content: [
    {
      type: "story",
      text: "In the desert, a man with wild hair and camel-skin clothes shouted to the crowds. His name was John the Baptist. He told people to stop doing wrong and get ready—someone greater than him was coming!"
    },
    {
      type: "question",
      domain: "shape",
    ...
    {
      type: "story",
      text: "John baptized people in the Jordan River. He dipped them in the water as a sign that their hearts were clean. One day, Jesus came to be baptized too."
    },
    {
      type: "question",
      domain: "movement",
    ...
    {
      type: "story",
      text: "As Jesus came out of the water, the sky opened and the Holy Spirit came down like a dove. A voice from heaven said, 'This is my beloved Son. I am pleased with him.'"
    },
    {
      type: "question",
      domain: "sound",
    ...
    },
    {
      type: "question",
      domain: "mood",
      question: "When you picture Jesus in the wilderness after 40 days, what would his face most likely show?",
      options: [
        "Excited energy",
        "Silly laughter",
        "Calm strength and focus",
        "Full confusion and fear"
      ],
      correctAnswer: 2,
      explanation: "Even though tired, Jesus stayed focused and calm while resisting temptation."
    },
    {
      type: "story",
      text: "Jesus came out of the wilderness ready to begin teaching. People started to gather around him, amazed by his wisdom and kindness. His ministry had begun."
    },
    {
      type: "question",
      domain: "number",
...
export default johnBaptistMinistry;