// Parables of Jesus: Visualization and Meaning
const parablesJesusVisualization = {
  id: "parables-jesus-visualization",
  title: "Parables of Jesus: Visualization Journey",
  icon: "🌾",
  difficulty: "Medium",
  theme: "Wisdom",
  ...
  content: [
    {
      type: "story",
      text: "Jesus loved to teach using parables - simple stories that help us understand big truths. Today we'll explore several parables and use our imagination to see what Jesus was teaching."
    },
    {
      type: "question",
      domain: "what",
    ...
    {
      type: "story",
      moral: "Jesus' parables use simple stories to teach deep truths. By visualizing these stories, we can better understand God's love, justice, and the importance of how we treat others."
    }
  ]
};

export default parablesJesusVisualization;